...
public class BagServiceImpl implements BagService {
    ...
    @Autowired
    public BagServiceImpl(final BagRepository repository, final ModelMapper mapper){
    ...
    @Override
    @Transactional
    public BagDTO create(final NewBagDTO newBagDTO) {
    ...
    public List<BagDTO> getAll() {
        final List<Bag> bags = repository.findAll();
    ...
    @Override
    @Transactional(readOnly = true)
    public BagDTO findById(final long id) {
        final Bag bag = repository.findById(id).orElseThrow(
